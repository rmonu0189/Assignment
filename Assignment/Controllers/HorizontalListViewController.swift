...
class HorizontalListViewController: UICollectionViewController {
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.userImageView?.imageFromURL(picture.image, placeholder: nil, handler: { (image) in
            if let currentCell = collectionView.cellForItem(at: indexPath) as? HorizontalListCell {
